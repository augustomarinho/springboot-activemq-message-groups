...
@Component
public class QueueOrdered implements MessageListener {

    private static final Logger logger = LoggerFactory.getLogger(ActiveMQSender.class);

    @JmsListener(destination = Queues.QUEUE_ORDERED,
            concurrency = "10-10",
    ...
    public void onMessage(Message message) {
        try {
            ...
            logger.error("Problems for consuming messagem from queue {}.", Queues.QUEUE_ORDERED);
